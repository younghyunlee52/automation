...
back <- read_Qualtrics("D:/GitHub/automation/Subject Pool - Fall 2024 - Background Survey_November 4, 2024_16.16.csv") %>%
  select(7:ncol(.))
exp <- read_Qualtrics("D:/GitHub/automation/Subject Pool - Fall 2024 - wave 1 - Lee_November 4, 2024_16.22.csv") %>%
